<template>
  <div class="min-w-[768px] relative h-screen flex text-white">
    ...
    <!-- Side bar -->
    <div class="w-[24%] 2xl:w-[13%] px-5 pt-6 bg-black text-light-secondary text-sm font-medium">
      ...
      <div class="mt-10 space-y-4">
        <button class="flex gap-x-3 hover:text-white transition">
          <svg fill="currentColor" role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon"><path d="M13.5 1.515a3 3 0 0 0-3 0L3 5.845a2 2 0 0 0-1 1.732V21a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6h4v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V7.577a2 2 0 0 0-1-1.732l-7.5-4.33z"></path></svg>
          Inicio
        </button>
        <button class="flex gap-x-3 hover:text-white transition">
          <svg fill="currentColor" role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon"><path d="M10.533 1.279c-5.18 0-9.407 4.14-9.407 9.279s4.226 9.279 9.407 9.279c2.234 0 4.29-.77 5.907-2.058l4.353 4.353a1 1 0 1 0 1.414-1.414l-4.344-4.344a9.157 9.157 0 0 0 2.077-5.816c0-5.14-4.226-9.28-9.407-9.28zm-7.407 9.279c0-4.006 3.302-7.28 7.407-7.28s7.407 3.274 7.407 7.28-3.302 7.279-7.407 7.279-7.407-3.273-7.407-7.28z"></path></svg>
          Buscar
        </button>
        <button class="flex gap-x-3 hover:text-white transition">
          <svg fill="currentColor" role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon"><path d="M14.5 2.134a1 1 0 0 1 1 0l6 3.464a1 1 0 0 1 .5.866V21a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1V3a1 1 0 0 1 .5-.866zM16 4.732V20h4V7.041l-4-2.309zM3 22a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zm6 0a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1z"></path></svg>
          Tu bibliotecca
        </button>
      </div>
      ...
      <div class="mt-10 space-y-4">
        <a href="#" class="group flex gap-x-4 hover:text-white transition">
          <div class="w-6 h-6 grid bg-gray-400 rounded group-hover:brightness-150 transition">
            <svg class="w-4 h-4 place-self-center text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
          </div>

          <div class="flex-1 whitespace-nowrap overflow-hidden text-ellipsis">Crear lista</div>
        </a>
        <a href="#" class="group flex gap-x-4 hover:text-white transition">
          <div class="w-6 h-6 grid bg-gradient-to-tl from-indigo-600 to-slate-300 rounded group-hover:brightness-150 transition">
            <svg class="w-4 h-4 place-self-center text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" /></svg>
          </div>

          <div class="flex-1 whitespace-nowrap overflow-hidden text-ellipsis">Canciones que me gustan</div>
        </a>
      </div>
    ...
    <!-- Playback bar -->
    <div class="absolute w-full bg-neutral-900 bottom-0 h-24 border-t border-neutral-700">

      <div class="px-4 flex justify-between h-full">
        <div class="flex items-center gap-x-4">

          <div>
            <img class="w-14" src="/images/thumb-song.jpeg" alt="">
          </div>
          <div>
            <button class="text-sm hover:underline block">Moriste</button>
            <button class="text-xs hover:underline block">Sergio Sacoto</button>
          </div>
          <div>
            <Like
              :like="true"
